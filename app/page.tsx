  ...
  return (
    <main className="container mx-auto py-10 px-4 md:px-6">
      <div className="flex flex-col items-center justify-center mb-10">
        <h1 className="text-4xl font-bold tracking-tight mb-2">Student Job Tracker</h1>
        ...
        <TabsContent value="add">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track a new job application you've submitted.</CardDescription>
            </CardHeader>
            <CardContent>
              <JobApplicationForm />
            </CardContent>
